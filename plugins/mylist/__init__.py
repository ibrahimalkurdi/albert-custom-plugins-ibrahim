"""
This extension show my todo list.
"""
...
#md_id = ""
md_name = "My List"
md_description = "Show my todo list in a popup screen"
md_license = "BSD-2"
...
class Plugin(QueryHandler):
    ...
    def handleQuery(self, query):
        ...
        query.add(Item(
            ...
            actions=[Action('Run script', 'Run Script', lambda: subprocess.Popen(['bash', '/home/ibrahim/scripts/show-up-my-todo-list.sh' ]) )]
        ))
